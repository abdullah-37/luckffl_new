...
import 'package:luck_ffle/app/Controllers/walkthrough_controller.dart';
...
class Walkthrough extends GetView<WalkthroughController> {
            ...
            children: [
              ...
              SmoothPageIndicator(
                ...
                effect: const SlideEffect(
                  dotHeight: 4,
                  activeDotColor: AppColors.sliderColor,
                  dotColor: AppColors.unselectedSliderColor,
                ),
              ),
              SizedBox(height: 35.h),
              _buildKakaoButton(),
              SizedBox(height: 15.h),
              _buildOtherStartButton(context),
            ],
          ),
        ),
      ),
  ...
  Widget _buildOtherStartButton(BuildContext context) {
    return GestureDetector(
      onTap: () {
